...
public class 애쉬 {
	...
	//속성(필드): 멤버변수
		...
		//생성자. (2개 이상 있으면 오버로드)
		public 애쉬(String team,String position,String skin, String roon, String spell) { // 스킨 있을 때 생성자
			this.team = team;
			this.position = position;
			this.skin = skin;
			this.roon = roon;
			this.spell = spell;
			System.out.println(this.team+"팀 "+this.position+" 애쉬(객체)가 생성되었습니다 ( 생성자에서 println )");
		}
		
		public 애쉬(String team, String position, String roon, String spell) { // 스킨 없을 때 생성자
			this.team = team;
			this.position = position;
			this.roon = roon;
			this.spell = spell;
